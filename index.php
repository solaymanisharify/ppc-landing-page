...
<head>
    ...
    <link rel="stylesheet" href="assets/css/stacking-card.css">
...
<body>
    ...
    <div class="sticky-parent">
        <div class="sticky">
            ...
            <div class="horizontal"> <!--Horizantal conatiner with display flex-->
                ...
                <div class="case-study-container-2">
                    <div class="case-study-container-text">
                        <div class="case-study-header">
                            <h2>From Growth to Succcess</h2>
                            <div class="golden-fox">
                ...
                <div class="case-study-container-3">
                    <div class="case-study-container-text">
                        <div class="case-study-header">
                            <h2>From Growth to Succcess</h2>
                            <div class="golden-fox">
    ...
    <div class="amazon-advertising-pricing">
        ...
        <div class="amazon-advertising-pricing-img">
            <img src="/assets/images/Desktop/Amazon-advertising.webp" alt="">
        </div>
    </div>
